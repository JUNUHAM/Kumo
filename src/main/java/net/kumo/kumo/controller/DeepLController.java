...
import net.kumo.kumo.domain.dto.deepl.TranslationRequest;
import net.kumo.kumo.domain.dto.deepl.TranslationResponse;
...
public class DeepLController {
    ...
    public ResponseEntity<TranslationResponse> translate(@RequestBody TranslationRequest request) {
        ...
        try {
            ...
            TranslationResponse response = restTemplate.postForObject(apiUrl, entity, TranslationResponse.class);
